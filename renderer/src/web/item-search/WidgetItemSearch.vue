      ...
      >
        ...
        >
          <ItemQuickPrice
            ...
            currency-text
          ></ItemQuickPrice>
          <div class="ml-1 truncate" style="max-width: 7rem">
            {{ item.info.name }}
          </div>
          <div v-if="item.discr" class="ml-1 truncate" style="max-width: 7rem">
            {{ t(item.discr) }}
          </div>
        </button>
      </transition-group>
      ...
      <div v-else class="bg-gray-800 rounded">
        ...
        <div class="flex gap-x-2 px-2 mb-px1 py-1">
          ...
          <div class="flex gap-x-1">
            <button
              :class="{ border: typeFilter === 'gem' }"
              class="rounded px-2 bg-gray-900"
              @click="typeFilter = 'gem'"
            >
              {{ t(":target_gem") }}
            </button>
            <button
